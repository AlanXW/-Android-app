...
public class ReleaseNewsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String TITLE_NAME = "New things";
    ...
    protected void initView() {
        ...
        uiFlusHandler = new MyDialogHandler(mContext, "login...");
    }
    ...
    private void checkInfo() {
        ...
        if (TextUtils.isEmpty(contentStr)) {
            DisplayToast("Please enter new things");
    ...
    private void getPhoto() {
        FishBun.with(ReleaseNewsActivity.this)
                ...
                .setAllViewTitle("All the pictures")
                .setActionBarTitle("Picture library")
                .textOnImagesSelectionLimitReached("Limited number has been selected!")
                .textOnNothingSelected("You haven't chosen a picture yet")
                .startAlbum();
    }
            ...
            switch (id) {
                case 1:
                    if (response.contains("success")) {
                        DisplayToast("New things are successful");
                        finish();
                    } else {
