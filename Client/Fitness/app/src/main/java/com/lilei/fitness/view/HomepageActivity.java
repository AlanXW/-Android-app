...
public class HomepageActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String TITLE_NAME = "About me";
    ...
    protected void initView() {
        ...
        uiFlusHandler = new MyDialogHandler(mContext, "Update...");
        echo();
    ...
    private void echo() {
        ...
        if (Constants.USER.getSex().equals("female")) {
                ...
                case 1:
                    ...
                    if (user == null) {
                        ...
                        if (result) {
                            ...
                            Toast.makeText(mContext, "Failure of user information storage", Toast.LENGTH_SHORT).show();
                        }
                    }
                    finish();
                    break;
