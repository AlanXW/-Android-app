...
public class NewsDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String TITLE_NAME = "Details of new things";
    ...
    protected void initView() {
        ...
        uiFlusHandler = new MyDialogHandler(mContext, "Loading...");
        refreshData();
    }
    ...
    private void showCommemtPane() {
        ...
        if (isShowCommentPane) {
            ...
            addCommentET.setHint("Publish a new comment");
            replyUsername = "";
    ...
    private void addNewComment() {
        ...
        if (TextUtils.isEmpty(commentText)) {
            DisplayToast("Please input the content first");
            return;
        }
                    ...
                    if (mList != null && mList.size() > 0) {
                        ...
                        adapter.setOnCommentButtonClickListner(new NewsDetailCommnetsAdapter.OnCommentButtonClickListner() {
                            ...
                            public void OnCommentButtonClicked(String replyUser) {
                                commentPane.setVisibility(View.VISIBLE);
                                addCommentET.setHint("Reply " + replyUser + " ");
        ...
        OkHttpUtils
                ...
                .execute(new BitmapCallback() {
                    ...
                    public void onError(Call call, Exception e, int i) {
                        DisplayToast("Unable to get a picture");
                    }
